...
//                },
                'sghud': {
                    ...
                    options: {
                        color: 'white',
                        //transparent:true,  //set true by hud.js by default
                        opacity: 0.99,
                ...
                'unitcube': {
                    ...
                    options: { wireframe: false,
                        color: 'white',
                        opacity: 1.0,
                        map: './app/media/images/dragons/d14_silhouette.png',
                        //transform: { t: [0, 0, -2], e: [0.0, 0.0, 0.0], s: [0.5, 1, 0.5] }
                        transform: { t: [0, 0, -2], e: [0.0, 0.0, 0.0], s: [1.0, 2, 1.0] }
                    }
                },
                'sgpointcloudlines': {
...
//# sourceMappingURL=pointcloudlinespost1.js.map
