    ...
    camera: {
        sg: {
            lens: {
                ...
                near: 0.01,
                far: 100000,
                //transform: { 't': [0, .01, 2], e:[0.0,3.14,0.0] } //y=.01 allows blue z-axis to be seen
                transform: { 't': [0, .51, -2], e:[0.0,3.14,0.0] } //y=.01 allows blue z-axis to be seen
            },
        }
    },
...
//                },
                ...
                'unitcube': {
                    ...
                    options: { wireframe: false,
                        ...
                        transparent:true,
                        opacity: 0.9,
                        map: './app/media/images/dragons/d13_transp_red.png',
                        //transform: { t: [0, 0, -2], e: [0.0, 0.0, 0.0], s: [0.5, 1, 0.5] }
                        transform: { t: [0, 0, -2], e: [0.0, 3.14, 0.0], s: [1.0, 2, 1.0] }
                    }
                },
                'sgpointcloud': {
                    factory: 'Pointcloud',
...
//# sourceMappingURL=pointcloud1.js.map
