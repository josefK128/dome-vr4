// topology4/mtn_dragons4.ts 
// webGL2, es300 three.ts ==0.125.2
const config = {
    // rendering topology
    topology: {
        // webxr?
...
//                },
                ...
                'vrcloud': {
                    ...
                    options: {
                        N: 4,
//                        urls: ["./app/media/images/dragons/d9_colored.png",
//                            "./app/media/images/dragons/d9_colored.png",
//                            "./app/media/images/dragons/d9_colored.png",
//                            "./app/media/images/dragons/d9_colored.png"],
                        urls: ["./app/media/images/dragons/d6_blue_spiral.png",
                            "./app/media/images/dragons/d5_blue.png",
                            "./app/media/images/dragons/d6_blue_spiral.png",
                            "./app/media/images/dragons/d19.png"],
                            //"./app/media/images/dragons/d14_silhouette.png"],
                        transparent: true,
                        opacity: 0.5,
                        cloudRadius: 1000,
                        translateZ: 1000,
                ...
                'vrskybox': {
                    ...
                    options: {
                        ...
                        opacity: 1.0,
                        textures: [
                            './app/media/images/skybox/snowmountain/px.jpg',
                            './app/media/images/skybox/snowmountain/nx.jpg',
                            './app/media/images/skybox/snowmountain/py.jpg',
                            './app/media/images/skybox/snowmountain/ny.jpg',
                            './app/media/images/skybox/snowmountain/pz.jpg',
                            './app/media/images/skybox/snowmountain/nz.jpg'
...
//# sourceMappingURL=vrcloudskybox4.js.map
