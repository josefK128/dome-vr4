// topology4/dragon_spritecloud4.ts 
...
//                },
                'unitcube': {
                    ...
                    options: { wireframe: false,
                        color: 'white',
                        opacity: 0.8,
                        //map: './app/media/images/dragons/d18_red_eyes.png',
                        map: './app/media/images/dragons/d9_colored.png',
                        transform: { t: [0, 0, -2], e: [0.0, 0.0, 0.0], s: [2.5, 4, 2.5] }
                    }
                },
                // spritecloud
                'vrcloud': {
...
//                        urls: ["./app/media/images/cloud/sprite_redlight.png",
                        urls: ["./app/media/images/dragons/d5_blue.png",
                            "./app/media/images/cloud/moon_256.png",
                            "./app/media/images/cloud/lotus_64.png",
                            "./app/media/images/cloud/sprites/ball.png"],
                        transparent: true,
                        opacity: 1.0,
                        cloudRadius: 1000,
                        translateZ: 1000,
...
//# sourceMappingURL=vrcloud4.js.map
